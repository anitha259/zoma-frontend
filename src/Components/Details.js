...
class Details extends React.Component {
    ...
    componentDidMount() {
        ...
        axios({
            method: 'GET',
            url: `https://still-fjord-57940.herokuapp.com/restaurant/${restaurant}`,
    ...
    handleOrder = (resId) => {
        axios({
            method: 'GET',
            url: `https://still-fjord-57940.herokuapp.com/menuitems/${resId}`,
            headers: { 'Content-Type': 'application/json' }
        })
            .then(response => {
    ...
    getData = (data) => {
        return fetch(`https://still-fjord-57940.herokuapp.com/payment`, {
            method: "POST",
            headers: {
    ...
    render() {
        ...
        return (
            <div>
                <div>
                    <img src={`./${restaurant.image}`} alt="Sorry for the Inconvenience" width="100%" height="300px" />
